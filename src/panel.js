...
async function onPostButton(interaction) {
  ...
  const panelEmbed = new EmbedBuilder().setColor(config.color).setTitle(config.title).setDescription(config.description).setFooter({ text: "Obno's Slave • Ticket System" });
